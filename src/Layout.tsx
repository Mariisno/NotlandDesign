    ...
    <LanguageContext.Provider value={{ lang, setLang }}>
            ...
            onClick={() => {
              ...
              for (let i = 0; i < 12; i++) {
                ...
                flower.style.transition =
                  "transform 2.2s cubic-bezier(.4,1.3,.6,1), opacity 0.7s";
                setTimeout(() => {
                  flower.style.transform = `translateY(${
                    window.innerHeight * 0.8 + Math.random() * 60
      ...
      <footer className="footer">
        ...
        >
          ...
          <p>
            &copy; 2025 NotlandDesign. Designed by Mari Svennevik Notland with
            fun and care.
          </p>
        </div>
      </footer>
